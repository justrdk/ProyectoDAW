                    ...
                    <div class="box">
                        ...
                        <table id="cantidades">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <td><%=tipos.get(i)%></td> <td><input type="text" class="cant" value="0" /></td><td>L. <%=costos.get(i)%></td><td class="sub">L. 0.00</td>
                                </tr>
                                <% }
                                %>
                            </tbody>
                            ...
                            <hr />
                            <div id="total"> Total: L. <span id="tot">0.00</span> </div>

                        <br /> <br />
                        <img src="css/images/pantalla.png">
                        <table id="sillas">    
